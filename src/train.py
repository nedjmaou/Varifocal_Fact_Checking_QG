...
class DataTrainingArguments:
    ...
    source_column: Optional[str] = field(
        default=None,
        metadata={"help": "The name of the column in the datasets containing the claims, metadata and additional context if any."},
    )
...
def main():
    ...
    #
    # For CSV/JSON files this script will use the first column for the claim and context and the second column for the
    # questions (unless you specify column names for this with the `source_column` and `target_column` arguments).
    #
    ...
    # for par in model.model.encoder.parameters():
    #     print(par.requires_grad)

    # freeze_params(model.model.encoder)

    # squad_model = AutoModelForSeq2SeqLM.from_pretrained(
    #     'models/generator/squad',
    #     from_tf=bool(".ckpt" in 'models/generator/squad'),
    #     config=config,
    #     cache_dir=model_args.cache_dir,
    #     revision=model_args.model_revision,
    #     use_auth_token=True if model_args.use_auth_token else None,
    ...
    # model.model.encoder = squad_model.model.encoder
    ...
    trainer = Seq2SeqTrainer(
        ...
        callbacks=[early_stopper], # Moy add early stopper
    )
